...
if ( !function_exists( 'pastore_church_options_settings_theme_setup' ) ) {
	...
	function pastore_church_options_settings_theme_setup() {
		...
		'homepage_show_events' => array(
					"title" => esc_html__('Show Events On Homepage', 'pastore-church'),
					"desc" => wp_kses_data( __('Determines if the event widget is visible or not') ),
					"std" => "yes",
					"options" => pastore_church_get_options_param('list_yes_no'),
					"type" => "switch"
					),
		...
		'homepage_events_rev_arrows' => array(
		...
		'homepage_show_news' => array(
					"title" => esc_html__('Show News On Homepage', 'pastore-church'),
					"desc" => wp_kses_data( __('Determines if the news feed widget is visible or not') ),
					"std" => "yes",
					"options" => pastore_church_get_options_param('list_yes_no'),
					"type" => "switch"
					),
		...
		'homepage_news_rev_arrows' => array(
					"title" => esc_html__('Use revolution slider arrows instead', 'pastore-church'),
					"desc" => wp_kses_data( __('Determine if you want the arrows to match the main slider on the homepage') ),
					"std" => "yes",
					"options" => pastore_church_get_options_param('list_yes_no'),
		...
		"footer_copyright" => array(
					...
					"allow_html" => true,
					"std" => "Pastore Church &copy; 2017 All Rights Reserved ",
					"rows" => "10",
					"type" => "editor"),
		...
		"api_google" => array(
					...
					"desc" => wp_kses_data( esc_html__("Insert Google API Key for browsers into the field above to generate Google Maps", 'pastore-church') ),
					"std" => "",
					"type" => "text"),
		));
