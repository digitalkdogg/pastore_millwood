...
<body <?php body_class();?>>
	...
	if (pastore_church_get_custom_option('menu_toc_home')=='yes')
		pastore_church_show_layout(pastore_church_sc_anchor(array(
			'id' => "toc_home",
		...
		<div class="page_wrap">
			...
			if ($show_title || $show_breadcrumbs) {
				...
				<div class="top_panel_title <?php echo (!empty($show_title) ? ' title_present'.  ($show_navi ? ' navi_present' : '') : '') . (!empty($show_breadcrumbs) ? ' breadcrumbs_present' : ''); ?> scheme_<?php echo esc_attr($top_panel_scheme); ?>">
					<div class="top_panel_title_inner top_panel_inner_style_<?php echo esc_attr(str_replace('header_', '', $top_panel_style)); ?> <?php echo (!empty($show_title) ? ' title_present_inner' : '') . (!empty($show_breadcrumbs) ? ' breadcrumbs_present_inner' : ''); ?>" <?php pastore_church_show_layout($header_css); ?>>
