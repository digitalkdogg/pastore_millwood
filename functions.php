...
function my_footer_scripts(){
    wp_enqueue_style( 'customcss', get_stylesheet_directory_uri() . '/staticresources/custom-css.css' );
	  wp_enqueue_script( 'customjs', get_stylesheet_directory_uri() . '/staticresources/custom-js.js' );
